...
class FtxClient:
    ...
    def place_order(self,
                    ...
                    client_id: str = None,
                    reject_after_ts: float = None) -> dict:
        return self._post(
            'orders', {
                'market': market,
                'side': side,
    ...
    def get_last_historical_prices(self,
                                   market: str,
                                   resolution: int = 300) -> List[dict]:
        return self._get(f'markets/{market}/candles/last',
                         {'resolution': resolution})
    ...
    def get_trigger_order_triggers(self,
    ...
    def place_staking_request(self,
                              coin: str = 'SRM',
    ...
    def submit_fiat_withdrawal(self,
                               coin: str,
                               size: int,
    ...
    def get_latency_stats(self,
                          days: int = 1,
                          subaccount_nickname: str = None) -> Dict:
